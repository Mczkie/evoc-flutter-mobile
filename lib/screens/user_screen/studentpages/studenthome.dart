  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: _StudenthomeState.primaryColor,
      ),
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final color =
              categoryColors[item['title']] ?? _StudenthomeState.accentColor;
                        ...
                        children: [
                          Text(
                            ...
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: _StudenthomeState.textDark,
                            ),
                          ),
                          const SizedBox(height: 4),
                          Text(
                            ...
                            style: const TextStyle(
                              fontSize: 14,
                              color: _StudenthomeState.textLight,
                            ),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ),

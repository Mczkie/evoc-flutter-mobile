  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: _NormaluserhomeState.primaryColor,
      ),
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final color =
              categoryColors[item['title']] ?? _NormaluserhomeState.accentColor;
                        ...
                        children: [
                          Text(
                            ...
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: _NormaluserhomeState.textDark,
                            ),
                          ),
                          const SizedBox(height: 4),
                          Text(
                            ...
                            style: const TextStyle(
                              fontSize: 14,
                              color: _NormaluserhomeState.textLight,
                            ),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ),
